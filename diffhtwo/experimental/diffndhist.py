...
_tw_ndhist_kern_vmap = jjit(vmap(_tw_ndhist_kern, in_axes=(0, None, None, None)))
...
_tw_ndhist_vmap = jjit(vmap(_tw_ndhist_sumkern, in_axes=(None, 0, 0, 0)))
...
# )
_tw_ndhist_weighted_sum_vmap = jjit(
    vmap(_tw_ndhist_weighted_sum_kern, in_axes=(0, None, 0, None, None))
)
...
# )
_tw_ndhist_weighted_vmap = jjit(
    vmap(_tw_ndhist_weighted_kern, in_axes=(None, 0, None, 0, 0))
)
