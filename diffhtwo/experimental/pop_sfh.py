...
def bimodal_SF_Q_draws(theta, N, k0, k1, k2, dex_var=0.1):
...
def pop_bimodal(
    ...
    lg_sfr_draws, SF_weights = bimodal_SF_Q_draws(
        theta, N, random.PRNGKey(0), random.PRNGKey(1), random.PRNGKey(2)
    )
