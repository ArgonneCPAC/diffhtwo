...
def nd_mag_kern(
    ...
    for band in range(1, n_bands):
        ...
        mag_colors_q = jnp.hstack((mag_colors_q, color))
    ...
    for band in range(1, n_bands):
        ...
        mag_colors_smooth_ms = jnp.hstack((mag_colors_smooth_ms, color))
    ...
    for band in range(1, n_bands):
        ...
        mag_colors_bursty_ms = jnp.hstack((mag_colors_bursty_ms, color))
