...
def nd_mag_kern(
    ...
    mag_colors_q = mag_colors_q.T.reshape(mag_colors_q.T.size, n_bands)
    ...
    mag_colors_smooth_ms = mag_colors_smooth_ms.T.reshape(
        mag_colors_smooth_ms.T.size, n_bands
    )
    ...
    mag_colors_bursty_ms = mag_colors_bursty_ms.T.reshape(
        mag_colors_bursty_ms.T.size, n_bands
    )
