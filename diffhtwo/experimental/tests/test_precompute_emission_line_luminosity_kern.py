...
def test_precompute_fsps_halpha_luminosity(
    ...
    ssp_halpha_line_luminosity = np.zeros(
        (ssp_data.ssp_lgmet.shape[0], ssp_data.ssp_lg_age_gyr.shape[0])
    )
    n_met = ssp_halpha_line_luminosity.shape[0]
    n_age = ssp_halpha_line_luminosity.shape[1]
